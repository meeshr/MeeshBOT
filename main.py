...
# ==========================================================
BOT_TOKEN = "MTU0NzY3MDMzNzY5OTcxMzA0NA.GWZ9Wy.V4VFIKWqwJqXvWqABGEco874SAng0oQVwrKe7s"
GUILD_ID = discord.Object(id=714659822477246534)
FORUM_CHANNEL_ID = 1547663433850425497
DB_FILE = "wishes_data.json"

# ==========================================================
# 2. باليت الألوان (COLOR PALETTE)
# ==========================================================
...
# ==========================================================
# 3. باليت الصور والبنرات والـ Thumbnails
# ==========================================================
...
# الصور المصغرة الجانبية للرسائل التأكيدية
...
# ==========================================================
# 7. إدارة قاعدة البيانات المحلية
# ==========================================================
def load_db():
...
    # منع الكتابة في فورم/ثريد شخص آخر
